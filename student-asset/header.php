...
<link rel="icon" type="image/x-icon" href="../images/chmsc.png">
 ...
 <body>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="<?php echo WEB_ROOT; ?>student/stud_dashboard.php" style="color: orange;">NSTP</a>
...
<ul class="navbar-nav ml-auto ml-md-0" style="background-color: black;border-radius: 5px;">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
         <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
             ...
             <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="color: white; font-size: 15px;"><?php echo $_SESSION['student_name']; ?></span>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo WEB_ROOT; ?>student-asset/logout.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
