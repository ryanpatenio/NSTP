...
$mydb->setQuery("select count(s.STUD_ID) as 'count' from students s,sections sec ,nstp_prog nst where s.SECT_ID = sec.SECT_ID and sec.NSTP_ID = nst.NSTP_ID ; ");
...
$mydb->setQuery("select count(*) as 'INC' from inc_students where STATUS ='INC';");
...
$mydb->setQuery("select count(*) as 'DROP' from drop_students where STATUS ='DROP';");
