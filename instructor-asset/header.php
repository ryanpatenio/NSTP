...
<head>
 ...
 <meta charset="utf-8">
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo WEB_ROOT; ?>images/chmsc.png">
...
<body id="page-top">
    ...
    <img src="../images/chmsc.png" style="width: 40px; margin-right: 10px; border-radius: 10px;">
    <a class="navbar-brand mr-1" href="<?php echo WEB_ROOT; ?>Inst-main/" style="color: orange;">INSTRUCTOR</a>
...
<ul class="navbar-nav ml-auto ml-md-0" style="background-color: black;border-radius: 5px;">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="<?php echo WEB_ROOT; ?>Inst-account/">
