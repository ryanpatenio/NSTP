...
<div class="modal fade bd-example-modal-sm" id="dropEnroll2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
                  ...
                  <div class="form-row">
                      <div class="col-md">
                          <label for="">Class:</label>
                             ...
                             <select class="form-control" name="cl2">
                  ...
                  <div class="form-row">
                      <div class="col-md">
                          <label for="">School Year:</label>
                           <select class="form-control" name="sy2">
                  ...
                  <div class="form-row">
                      <div class="col-md">
                          <label for="">Semester:</label>
                             ...
                             <input class="form-control input-sm" id="sem" readonly name="sem2" placeholder=
      ...
      <div class="modal-footer">
        ...
        <input type="button" class="btn btn-primary" name="reEn2" value="ADD">
