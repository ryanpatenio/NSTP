...
//have no data
#then lets include the empty div

  include('empty/student_data_empty.php');
     ...
     <div class="card-header">
      ...
      <div class="card-body">
           ...
           <div class="form-group">
            ...
            <a class="btn btn-sm btn-danger " href="../inc-students/" style="cursor: pointer;color: white;">Click here to go INC Page!</a>
            ...
            <a class="btn btn-sm btn-secondary " href="../adminDropStudent/" style="cursor: pointer;color: white;">Click here to go DROP Page!</a>
...
<?php 
    ...
    //have no data
    #then lets include the empty fields
    include('empty/first.php');



  }//end of res2 first semester records
...
<!--------------------End of first semester records--------------------------------->

<!--------------------Second Semester Record---------------------------------------->
...
<?php
  ...
  // have no data!
  #then lets include the empty fields
  include('empty/secondSem.php');



}//end of second semester query
